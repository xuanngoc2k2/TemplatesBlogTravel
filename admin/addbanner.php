        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <?php
                    if (isset($insert_banner)) {
                        echo $insert_banner;
                    }
                    ?>
                    <div class="row">
                        <div class="col-md-5 col-sm-12">
                            <form class="user" style="width: 500px; max-width: 100%;" method="post" action="addbanner.php" enctype="multipart/form-data">
                                <div class="form-group" style="font-size: 18px;">
                                    ...
                                    <textarea class="form-control" style="font-size: 18px;" name="bannerDetail" placeholder="Nhập chi tiết banner ..."></textarea>
                        ...
                        <div class="col-md-7 col-sm-12">
                            <img id="showImage" style="max-width: 100%;" src="" alt="Ảnh Banner" />
                        </div>
                    </div>
                </div>
                <!-- /.container-fluid -->
